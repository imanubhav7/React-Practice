    ...
    const amountInputId = useId();
{
  return (
    <div className={`bg-white p-3 rounded-lg text-sm flex`} >
        ...
        <input id={amountInputId} className='outline-none w-full bg-transparent py-1.5' placeholder='Amount' type="number" disabled={amountDisable} value={amount} onChange={(e) => onAmountChange && onAmountChange(Number(e.target.value))} />
        </div>

        <div className="w-1 flex flex-wrap justify-end text-right">
